...
const UpdatePanduanGiziForm = ({
  ...
  return (
    <>
      ...
      <section>
        <h2 className="text-xl font-semibold tracking-tight">Catatan : </h2>
        <p className="border-l-2 pl-3 my-4">
          {panduanGizi?.catatan_admin ?? "-"}
        </p>
      </section>
      <hr />
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-8">
          ...
          <FieldSet className="gap-4">
            ...
            <FieldGroup className="gap-4 flex flex-row flex-wrap">
