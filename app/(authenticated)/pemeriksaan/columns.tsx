...
export const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  {
    accessorKey: "anak.tempat_lahir",
    header: "Tempat Lahir",
  },
  {
    accessorKey: "anak.tanggal_lahir",
    header: "Tanggal Lahir",
    cell: ({row}) => {
      const date = format(row.original.anak?.tanggal_lahir, "dd-MM-yyyy");
      return date;
    },
  },
  {
